...
module.exports = function handler(req, res) {
  ...
  // Static file under /public/ics/ — a clean path with no query string, so
  // corporate email security gateways (Mimecast, Proofpoint, Safe Links)
  // that strip query params on link rewrite don't break the download.
  const staticIcsUrl = `${baseUrl}/ics/${event.id}.ics`;
